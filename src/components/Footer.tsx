        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-4 mb-6">
              ...
              <li>
                <a href="mailto:support@coin-zone.shop" className="flex items-center gap-3 text-gray-400 hover:text-white transition-colors group">
                  ...
                  <span className="text-sm">support@coin-zone.shop</span>
                </a>
              </li>
            </ul>

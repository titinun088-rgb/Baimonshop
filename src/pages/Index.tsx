...
const Index = () => {
  ...
  return (
    <>
      <Seo title="เติมเกมแอปพรีเมียม - CoinZone" description="CoinZone บริการเติมเกมออนไลน์, บัตรเติมเงิน, แอปพรีเมียม และสินค้าดิจิทัลมากมาย รวดเร็ว ปลอดภัย 24 ชั่วโมง" />
      <Landing />
    </>
  );
};

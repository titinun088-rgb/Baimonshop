  ...
  return (
    <Layout>
      ...
      <SchemaMarkup 
        type="service"
        data={{
          name: "บริการเติมเกมออนไลน์ CoinZone",
